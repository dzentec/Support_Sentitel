...
• Заканчивай подписью: «С уважением,\nКоманда поддержки»

ФОРМАТ ОТВЕТА — строго JSON, без markdown-обёртки, без пояснений:
{"classification":"spam|not_spam","confidence":0.0,"category":"billing|technical|general|other|null","spam_reason":"строка или null","draft_reply":"текст или null"}
"""
